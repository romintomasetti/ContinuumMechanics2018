...
def main(nogui):
    ...
    psi = 0
    Id = 5
    algo = UpdatedNormalPlaneArcLengthAlgorithm(truss, tol, nItMax,dlamda0, psi, Id)
    ...
    plt.title('Updated normal plane',fontsize=26)
    plt.grid(True)
    plt.show()
	
    print 'Parameters used: dlambda_0(',dlamda0,'), Id(',Id,'), psi(',psi,')'
    print 'Number of evaluations of Kt: ',bar1.numberOfKtEvals
